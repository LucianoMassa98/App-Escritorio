...
namespace E_Shop.ServiceReferenceWSAA {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://wsaahomo.afip.gov.ar/ws/services/LoginCms", ConfigurationName="ServiceReferenceWSAA.LoginCMS")]
    public interface LoginCMS {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(E_Shop.ServiceReferenceWSAA.LoginFault), Action="", Name="fault")]
        E_Shop.ServiceReferenceWSAA.loginCmsResponse loginCms(E_Shop.ServiceReferenceWSAA.loginCmsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<E_Shop.ServiceReferenceWSAA.loginCmsResponse> loginCmsAsync(E_Shop.ServiceReferenceWSAA.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LoginCMSChannel : E_Shop.ServiceReferenceWSAA.LoginCMS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<E_Shop.ServiceReferenceWSAA.LoginCMS>, E_Shop.ServiceReferenceWSAA.LoginCMS {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        E_Shop.ServiceReferenceWSAA.loginCmsResponse E_Shop.ServiceReferenceWSAA.LoginCMS.loginCms(E_Shop.ServiceReferenceWSAA.loginCmsRequest request) {
            return base.Channel.loginCms(request);
        }
        
        public string loginCms(string in0) {
            E_Shop.ServiceReferenceWSAA.loginCmsRequest inValue = new E_Shop.ServiceReferenceWSAA.loginCmsRequest();
            inValue.in0 = in0;
            E_Shop.ServiceReferenceWSAA.loginCmsResponse retVal = ((E_Shop.ServiceReferenceWSAA.LoginCMS)(this)).loginCms(inValue);
            return retVal.loginCmsReturn;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<E_Shop.ServiceReferenceWSAA.loginCmsResponse> E_Shop.ServiceReferenceWSAA.LoginCMS.loginCmsAsync(E_Shop.ServiceReferenceWSAA.loginCmsRequest request) {
            return base.Channel.loginCmsAsync(request);
        }
        
        public System.Threading.Tasks.Task<E_Shop.ServiceReferenceWSAA.loginCmsResponse> loginCmsAsync(string in0) {
            E_Shop.ServiceReferenceWSAA.loginCmsRequest inValue = new E_Shop.ServiceReferenceWSAA.loginCmsRequest();
            inValue.in0 = in0;
            return ((E_Shop.ServiceReferenceWSAA.LoginCMS)(this)).loginCmsAsync(inValue);
        }
    }
}
