...
namespace E_Shop
{
    public partial class CargarRemitoEgreso: Form
    {
        Usuario xUsuario;
        Form FormularioAnterior;
        RemitoEgreso RemitoX;
        int inicio;
        public CargarRemitoEgreso(object x, ref Form y,  object z)
        {
            InitializeComponent();
            xUsuario = (Usuario)x;
            FormularioAnterior = y;
            RemitoX = (RemitoEgreso)z;
        ...
        public void CrearRemito() {
            ...
            if (RemitoEgreso.Crear(RemitoX))
            {
                try
                {
                    RemitoX.Directo = checkBox2.Checked;
                    RemitoX.Cobrado = false;
